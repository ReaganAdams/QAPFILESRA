# QAP 4 Python program for One Stop Insurance compnay
# Author Reagan Adams Nov.28th , 2023
# Program able to calculate new insurance policy information for One Stop Insurance customers.
...
print("\nWelcome to One Stop Insurance Company Policy Calculator \n\n** Demo: Press enter will work...\n")
...
def main():
      ...
      if payment_method_input == 'D':
            down_payment = float(get_validated_input("Enter the down payment total: ", default="0", validation_func=lambda x: x.replace('.', '', 1).isdigit()))
      ...
      # Calculate monthly payment when needed
      monthly_payment = 0.0
      ...
      print("\nThank you for using One Stop Insurance Company Policy Calculator.")
